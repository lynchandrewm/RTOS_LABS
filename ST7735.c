...
static uint16_t screen0_height = ST7735_TFTHEIGHT/2;
static uint16_t screen1_height = ST7735_TFTHEIGHT/2;

static uint16_t screen0_current_x = 0;
static uint16_t screen0_current_y = 0;
